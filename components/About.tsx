    ...
    return (
        <section className="section">
            <div id="about" className="about text-xl text-center pb-[217px] md:pb-[330px] scroll-mt-[7rem]">
                <div className="w-full justify-center items-center justify-items-stretch grid grid-cols-1 grid-rows-[360px] md:grid-cols-[minmax(0,485px)_minmax(0,485px)] gap-[25px]">
